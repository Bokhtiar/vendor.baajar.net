...
export const index = async () => {
    return await privateRequest.get(`/vendor/earning`);
};
/* list of resource */
export const history = async (queryParams) => {
    return await privateRequest.get(`/vendor/withdraw-history?${queryParams}`);
};
